...
$C_\star>2$. The two use separately gated certificate chains, but share
definitions, analytic machinery, and the finite core; they are not claimed as
fully independent implementations. Theorem~\ref{thm:sq} is retained because
its proof is the structural one, and because the slack it leaves is uniform
and explicit:
\[
  \rho(r,t)-1\ge \rho(129,2)-1
  =0.014576164564870742\ldots,
\]
with equality only at $(129,2)$.
